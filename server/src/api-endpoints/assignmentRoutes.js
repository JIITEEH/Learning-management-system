...
import { allowHandIn, handIn, listSubmissions, returnAllGraded } from '../request-handlers/submissionController.js';
...
router.post('/:id/return-all', requirePermission('submission.grade'), returnAllGraded);
